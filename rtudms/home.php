 ...
 <div class="col-md-12 "style="">
   <div class="container-fluid mt-5">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <!--Card content-->
        <div class="card-body d-md-flex justify-content-between shadow bg-light rounded-4">

          <h4 class="mb-2 mb-sm-0 pt-1 fw-bold">
            <a href="dashboard.php" style="text-decoration: none; color:#10164D; ">WELCOME TO RTUDMS - </a>
            <span style="color:#10164D;"><?php echo strtoupper(htmlentities($username)); ?></span>
            <span>|</span>
            <span style="color: #E0A100;">HOMEPAGE</span>
          </h4>
<!-- 
...
$result = mysqli_query($conn, "SELECT SUM(DOWNLOAD) AS sum FROM download_log WHERE MONTH = '$month'"); 
  $row = mysqli_fetch_assoc($result); 
  $sum = $row['sum'];      

$resultUp = mysqli_query($conn, "SELECT SUM(UPLOAD) AS sumUp FROM upload_log WHERE MONTH = '$month'"); 
...
?>
      ...
      <div class="col-md-3 rounded-4 ms-0">

<div class="container-fluid" style="visibility: hidden; display: none;" id="piechart_download">
        <div class="card mb-4 shadow bg-light rounded-4">

                      <!-- Card header -->
                      <div class="card-header bg-warning text-center fw-bold rounded-4">
                      <?php echo $month?> | Downloads
                      </div>

                      <!--Card content-->
                      <div class="card-body text-center p-4">

                        <h1 class="display-1 fw-bold"><?php if ($sum != 0){echo $sum;}else{ echo "0";}?></h1>
                        <button class="btn btn-outline-warning btn-sm float-end rounded-3" id="btnDownload">
...
<div class="container-fluid col-md-12 rounded-4" id="piechart_upload">
        <div class="card mb-4 shadow bg-light rounded-4">

                      <!-- Card header -->
                      <!-- Card header -->
                      <div class="card-header bg-warning text-center fw-bold rounded-4">
                      <?php echo $month?> | Uploads
                      </div>

                      <!--Card content-->
                       <div class="card-body text-center p-4">

                         <h1 class="display-1 fw-bold"><?php if ($sumUp != 0){echo $sumUp;}else{ echo "0";}?></h1>
                         <button class="btn btn-outline-warning btn-sm float-end rounded-3" id="btnHide" style="">
                           <i class="fa fa-eye-slash"></i>
                         </button>
...
<div class="col-md-9 ms-0 mb-3 rounded-4" id="upload">
  
      <div class="container-fluid mt-0 rounded-4">
     <div class="ms-0 card shadow bg-light rounded-4">
            <!--Card content-->
            <div class=" ms-0 card-body">

                                              <?php
                                  require_once("connection.php");

                                  $sql ="SELECT *,SUM(UPLOAD) as count FROM upload_log GROUP BY MONTH;";
                                  ...
                                  if (mysqli_num_rows($result) > 0) {
                                      while ($row = mysqli_fetch_array($result)) {
                                          $months[] = strtotime($row['MONTH'] . ' 1 2022');
                                          $counts[] = $row['count'];
                                      }

                                      array_multisort($months, SORT_ASC, $counts);
                                  ...
                                  ?>
                <CENTER><h3 class="page-header fw-bold" >Monthly Upload | Report  </h3></CENTER>  
...
<div class="col-md-9 ms-0 mb-3" id="download" style="visibility: hidden; position: absolute;">
   
      <div class="container-fluid mt-0">
     <div class="ms-0 card shadow bg-light rounded">
            <!--Card content-->
            <div class=" ms-0 card-body">
                                ...
                                $sql ="SELECT *,SUM(DOWNLOAD) as count FROM download_log GROUP BY MONTH;";
                                $result = mysqli_query($conn,$sql);
                                $chart_data="";
                                $months1 = array();
                                $counts1 = array();
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                      $months1[] = strtotime($row['MONTH'] . ' 1 2022');
                                      $counts1[] = $row['count'];
                                    }

                                    array_multisort($months1, SORT_ASC, $counts1);
                ...
                <CENTER><h3 class="page-header fw-bold" >Monthly Download | Report</h3></CENTER>  
...
<div class="modal fade rounded-4" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
...
<script>
document.getElementById("btnHide").addEventListener("click", hideUpload);

function hideUpload() {
    document.getElementById("upload").style.visibility = "hidden";
    document.getElementById("btnHide").style.visibility = "hidden";
    document.getElementById("upload").style.position = "absolute";
    document.getElementById("download").style.position = null;
    document.getElementById("download").style.display = "block";
    document.getElementById("download").style.visibility = "visible";
    document.getElementById("btnDownload").style.visibility = "visible";
    document.getElementById("piechart_download").style.visibility = "visible";
    document.getElementById("piechart_download").style.display = "block";
    document.getElementById("piechart_upload").style.display = "none";
...
<script>
document.getElementById("btnDownload").addEventListener("click", hideDownload);

function hideDownload() {
    document.getElementById("upload").style.visibility = "visible";
    document.getElementById("btnHide").style.visibility = "visible";
    document.getElementById("btnHide").style.visibility = "absolute";
    document.getElementById("upload").style.position = null;
    document.getElementById("download").style.position = "absolute";
    document.getElementById("download").style.visibility = "hidden";
    document.getElementById("btnDownload").style.visibility = "hidden";
     document.getElementById("piechart_download").style.display = "none";
    document.getElementById("piechart_upload").style.display = "block";
