...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <center><p class="mt-3 mb-4 mb-0 h3 fw-bold"> Enter New Password</p></center>
  ...
  <label for="email" id="emailph" textContent="">Confirm New Password</label>
    ...
    <input type="checkbox" onclick="unmask()"> Show Password <br><br>
        ...
        <button type="button" id="submitbtn1" class="float-start btn mb-3 col-6 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; " textContent=""><a href="unsetSessions.php" style="text-decoration: none; color:black;"><i class="fa fa-arrow-left"></i> Go Back</button></a>
        <button type="reset" id="resetbtn" class="float-end btn col-5 mb-3 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; " textContent=""><i class="fa fa-refresh"></i>   Reset</button>

        <button type="submit" id="submitbtn" name="submit" class="mt-0 btn col-12 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; " textContent="">Reset Password</button>
      </div>
    </form>
...
if($_POST["newpass"] === $_POST["confirmpass"]){
      ...
      if (mysqli_query($conn, $query)) {
        ...
        $query1 = "DELETE FROM resetpasswords WHERE code='$code'";
  ...
  text:'The Password Has Been Succesfully Reset and Confirmed!!',
