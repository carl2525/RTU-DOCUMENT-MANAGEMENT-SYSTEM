...
<html lang="en">
  <head>
    ...
    <title>RTU|DMS Upload File</title>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="gear-fill" viewBox="0 0 16 16">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg></symbol>
  ...
  <symbol id="folder" viewBox="0 0 16 16"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M928 444H820V330.4c0-17.7-14.3-32-32-32H473L355.7 186.2a8.15 8.15 0 0 0-5.5-2.2H96c-17.7 0-32 14.3-32 32v592c0 17.7 14.3 32 32 32h698c13 0 24.8-7.9 29.7-20l134-332c1.5-3.8 2.3-7.9 2.3-12 0-17.7-14.3-32-32-32zm-180 0H238c-13 0-24.8 7.9-29.7 20L136 643.2V256h188.5l119.6 114.4H748V444z"></path></svg></symbol>
  <symbol id="folder" viewBox="0 0 16 16"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M928 444H820V330.4c0-17.7-14.3-32-32-32H473L355.7 186.2a8.15 8.15 0 0 0-5.5-2.2H96c-17.7 0-32 14.3-32 32v592c0 17.7 14.3 32 32 32h698c13 0 24.8-7.9 29.7-20l134-332c1.5-3.8 2.3-7.9 2.3-12 0-17.7-14.3-32-32-32zm-180 0H238c-13 0-24.8 7.9-29.7 20L136 643.2V256h188.5l119.6 114.4H748V444z"></path></svg></symbol>
  <symbol id="addrescard"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="1.9em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H512c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zm80 256h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16c0-44.2 35.8-80 80-80zm96-96c0 35.3-28.7 64-64 64s-64-28.7-64-64s28.7-64 64-64s64 28.7 64 64zm128-32H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16zm0 64H496c8.8 0 16 7.2 16 16s-7.2 16-16 16H368c-8.8 0-16-7.2-16-16s7.2-16 16-16z"/></svg></symbol>
   <symbol id="userclock"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!-- Font Awesome Pro 5.15.4 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) --><path d="M496 224c-79.6 0-144 64.4-144 144s64.4 144 144 144 144-64.4 144-144-64.4-144-144-144zm64 150.3c0 5.3-4.4 9.7-9.7 9.7h-60.6c-5.3 0-9.7-4.4-9.7-9.7v-76.6c0-5.3 4.4-9.7 9.7-9.7h12.6c5.3 0 9.7 4.4 9.7 9.7V352h38.3c5.3 0 9.7 4.4 9.7 9.7v12.6zM320 368c0-27.8 6.7-54.1 18.2-77.5-8-1.5-16.2-2.5-24.6-2.5h-16.7c-22.2 10.2-46.9 16-72.9 16s-50.6-5.8-72.9-16h-16.7C60.2 288 0 348.2 0 422.4V464c0 26.5 21.5 48 48 48h347.1c-45.3-31.9-75.1-84.5-75.1-144zm-96-112c70.7 0 128-57.3 128-128S294.7 0 224 0 96 57.3 96 128s57.3 128 128 128z"/></svg></symbol>
      <symbol id="building"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M48 0C21.5 0 0 21.5 0 48V464c0 26.5 21.5 48 48 48h96V432c0-26.5 21.5-48 48-48s48 21.5 48 48v80h96c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48H48zM64 240c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V240zm112-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H176c-8.8 0-16-7.2-16-16V240c0-8.8 7.2-16 16-16zm80 16c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H272c-8.8 0-16-7.2-16-16V240zM80 96h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16zm80 16c0-8.8 7.2-16 16-16h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H176c-8.8 0-16-7.2-16-16V112zM272 96h32c8.8 0 16 7.2 16 16v32c0 8.8-7.2 16-16 16H272c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16z"/></svg></symbol>
     <symbol id="user"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0S96 57.3 96 128s57.3 128 128 128zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg></symbol>
    <symbol id="history"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9V168c0 13.3 10.7 24 24 24H134.1c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24V256c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65V152c0-13.3-10.7-24-24-24z"/></svg></symbol>
    <symbol id="userPlus"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><!--! Font Awesome Pro 6.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d="M352 128c0 70.7-57.3 128-128 128s-128-57.3-128-128S153.3 0 224 0s128 57.3 128 128zM0 482.3C0 383.8 79.8 304 178.3 304h91.4C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7H29.7C13.3 512 0 498.7 0 482.3zM504 312V248H440c-13.3 0-24-10.7-24-24s10.7-24 24-24h64V136c0-13.3 10.7-24 24-24s24 10.7 24 24v64h64c13.3 0 24 10.7 24 24s-10.7 24-24 24H552v64c0 13.3-10.7 24-24 24s-24-10.7-24-24z"/></svg></symbol>
   <symbol id="users"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M144 160c-44.2 0-80-35.8-80-80S99.8 0 144 0s80 35.8 80 80s-35.8 80-80 80zm368 0c-44.2 0-80-35.8-80-80s35.8-80 80-80s80 35.8 80 80s-35.8 80-80 80zM0 298.7C0 239.8 47.8 192 106.7 192h42.7c15.9 0 31 3.5 44.6 9.7c-1.3 7.2-1.9 14.7-1.9 22.3c0 38.2 16.8 72.5 43.3 96c-.2 0-.4 0-.7 0H21.3C9.6 320 0 310.4 0 298.7zM405.3 320c-.2 0-.4 0-.7 0c26.6-23.5 43.3-57.8 43.3-96c0-7.6-.7-15-1.9-22.3c13.6-6.3 28.7-9.7 44.6-9.7h42.7C592.2 192 640 239.8 640 298.7c0 11.8-9.6 21.3-21.3 21.3H405.3zM416 224c0 53-43 96-96 96s-96-43-96-96s43-96 96-96s96 43 96 96zM128 485.3C128 411.7 187.7 352 261.3 352H378.7C452.3 352 512 411.7 512 485.3c0 14.7-11.9 26.7-26.7 26.7H154.7c-14.7 0-26.7-11.9-26.7-26.7z"/></svg></symbol>
...
<div class="row d-md-block w-100 ms-0">
    <div class="d-flex flex-column flex-shrink-0 p-3 pt-4 float-start" id="sidebar">
    <a href="/" class="logo-wrapper">
      <img class="img-fluid mt-0" src="../assets/img/rtudms2.png" width="260px" height="60px"></img>
    </a>
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1" id="itemSidebar">
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
         <li>
        <a href="privatefiles.php" class="nav-link dropdown-item text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#lock"/></svg>
           - Private Files
        </a></li>
        <li>
        ...
        <li>
        <li>
        <a href="ownrequests.php" class="nav-link dropdown-item text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - My Requests
        </a></li>
        <li>
        ...
        <li>
        <a href="notyet_files.php" class="nav-link dropdown-item text-white">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Not Yet Seen Files
        </a></li>
        <li>
      ...
      <li>
        <a href="addfile.php" class="nav-link text-white active">
        ...
        <a href="#" class="nav-link text-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          Manage All Request
        </a><ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
    ...
    <div class="dropdown"id="namePosition" >
      ...
      <a href="#" class="d-flex align-items-centered text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <ul class="dropdown-menu dropdown-menu-dark text-small shadow" id="logout">
        <li><a class="dropdown-item" href="logout.php">Sign out <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#signout"/></svg></a></li>
      </ul>
    
    </div>
  </div>
</div>
   <div class="col-md-12 headertop ms-0" style= " background-color: #00396D; z-index: -1;" id="headerCustom">
...
<div class="collapse" id="navbarToggleExternalContent" style="background-color: #00396D;">
  <div class="dark p-4">
...
<div class="pt-3 ms-0 w-100 mb-6 border-bottom border-5 border-warning" id="customMenu" style="background-color: #00396D; height: 80px; ">
  <div class="container-fluid">
    <button class="mt-1 ms-2 btn btn-warning text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <div class="card-body d-sm-flex justify-content-between shadow bg-light rounded-4 ">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
            <a href="dashboard.php" style="text-decoration: none; color:#10164D; ">HOME PAGE</a>
            <span>|</span>
            <span style="color: #E0A100;">UPLOAD FILE DOCUMENT</span>
          </h4>
<!-- 
...
<div class="container-fluid">
    ...
    <a href="addfile.php"><button type="button" class="btn btn-success waves-effect waves-light rounded-4 "><svg class="" width="20" height="20"><use xlink:href="#view"></use></svg>View File Document</button></a>
    <hr>
    </div>
  </div>
...
<h5 class="card-header info-color rounded-4  white-text text-center py-4">
  <strong>UPLOAD FILE FORM DOCUMENT</strong>
  </h5>
  <div class=" card-body rounded-4  px-lg-6 pt-0">
    <div class="container">
      <div class="row"><br><br>
        <form action="fileprocess.php" id="add_form" method="post" enctype="multipart/form-data">
          <div class="col-md-11">
              <div class="md-form mb-0 text-center ms-5">
                ...
                <input type="hidden" name="designation" value="<?php echo $designation; ?>" class="form-control " readonly="">
...
<div class="input-group">
  ...
  <input type="file" class="form-control fw-bold rounded-3" id="firstname" name="myfile[]" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" multiple required>
...
<div class="col-md-10 mt-2">
  <div class="input-group">
         <input list="emailemployee" placeholder="Send to" name="sendTo" class="form-control rounded-3">

  <datalist class=""  aria-label="Default select example"  id="emailemployee" required style="display: none;">
    <option value="">Send File to</option>
    <option value="Private">Send to Private Files</option>
    <option value="All">Send to All</option>
 <?php
         require_once("connection.php");

        $query="SELECT * FROM login_user WHERE NAME!='$username'";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_assoc($result)){

         $sendUser = $file['email_address'];
      
          ?>    


    <option  name="sentuser" value="<?php echo $sendUser; ?>">Send to User Acc: <?php echo $sendUser; ?></option>  <?php  } ?>

    <?php

        $query1="SELECT * FROM admin_login WHERE NAME!='$username'";
        $result1=mysqli_query($conn,$query1);
        while($file1=mysqli_fetch_assoc($result1)){

         $sendUser1 = $file1['admin_user'];

    ?>

    <option  name="sentuser1" value="<?php echo $sendUser1; ?>">Send to Admin Acc: <?php echo $sendUser1; ?></option>  <?php  } ?>
...
<center>
<div class="col-md-10 mt-2">
  <textarea class="form-control rounded-3" id="exampleFormControlTextarea1" name="description" rows="4" placeholder="Enter Description Message" style="resize: none;"></textarea>
</div>
</center>

<div class="row d-flex justify-content-center">
<div class="col-md-5 mt-2">
  <select class="form-select fw-bold rounded-3" id="customOffice" name="department" aria-label="Default select example" required >
...
<div class="col-md-5 mt-2">
        <input type="text" maxlength="8" onkeypress="{return isNumberKey(event)}" inputmode="numeric" class="form-control rounded-3" id="email" placeholder="ID Control# 8 Digits Only" name="controlno">
            ...
            function isNumberKey(evt)
  {
     ...
     return true;
          ...
          <button type="submit" class="btn fw-bold btn-rounded btn-block mt-3 mb-3 waves-effect z-depth-0 rounded-3" name="save" id="addnew"style ="background:#E0A100;" ><i class="fa fa-upload"></i>   UPLOAD FILE</button>
         <p class="fw-bold" style="font-size: 12px"><b>File Type:</b><font color="red"><i>.docx .doc .pptx .ppt .xlsx .xls .pdf .odt</i></font></p>
         <p class="fw-bold" style="font-size: 12px; margin-top:-15px;"><b>Max File Upload: </b><font color="red"><i>5 Files Per Upload Only!!</i></font></p>
        </form>
      </div>
    </div>
  </div>
...
<div class="footerstyleUpload">
             <div class="col-md-12 headertop ms-0 position-relative bottom-0 start-0"  >
    <footer class="ms-0 w-100 py-3 mb-5 border-top border-5 border-warning mt-4 " id="footerSize">
      <center><p class="text-light my-0"id="footerText"> COPYRIGHT NICOLLO GROUP ALL RIGHTS RESERVED &copy; 2022</p></center>
    </footer>
</div></div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered rounded-5" role="document">
    <div class="modal-content bg-light rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 rounded-4" style="color: #10164D;"> ADD EMPLOYEE ACCOUNT</h4>
...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    $extension = pathinfo($filename, PATHINFO_EXTENSION);
      ...
      if(!in_array($extension, ['pdf', 'docx','pptx','ppt','xlsx','xls','odt'])) {
     echo "<script type='text/javascript'>
     document.querySelector('body').style.overflow = 'hidden';
     Swal.fire({
  icon: 'error',
  title: '$filename',
  text:'Your file extension must be: .pdf .docx .pptx .ppt . xlsx .xls .odt',
  confirmButtonColor:'#00396D',
   ...
   timer:3000
    ...
    } else if ($_FILES['myfile']['size'][$i] > 52428800) { // file shouldn't be larger than 1Megabyte
      echo "<script type='text/javascript'>
      document.querySelector('body').style.overflow = 'hidden';
      Swal.fire({
  icon: 'error',
  title: 'Error Uploading File!!',
  text:'Upload File Size Too Much Maximum 50mb Only!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
  ...
  icon: 'error',
  title: 'Error Uploading File!!',
  text:'Please Upload 5 Files at a Time Only!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
  ...
  $query=mysqli_query($conn,"SELECT NAME FROM `upload_files` WHERE `NAME` = '$filename '")or die(mysqli_error($conn));
        ...
        $newfilename = $temp[0].round(microtime(true)) . '.' . end($temp);
         ...
         if(!is_dir("../uploads/".$foldername)) mkdir("../uploads/".$foldername);
          if(move_uploaded_file($file,"../uploads/".$foldername."/".$newfilename)){
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$newfilename','$foldername', '$size','$description','$user', '$sendto', 0, '$time',0,'$designation', 'Admin', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
              ...
              $controlActionID= "CONTROL ID#: ".$controlno;

               $insertInNotification = "INSERT INTO notifcation_table (id, controlNumber, EMAIL, SENDTO, ACTION, FILENAME, TIMERS, SEEN_STATUS, LINK) 
              VALUES (0, '$controlActionID', '$email', '$sendto', 'Sent You a File With a Document Named', '$newfilename', '$time', 0, 'sharedwithme')";
              mysqli_query($conn, $insertInNotification);


              $insertQueryDownload = "INSERT INTO download_log (NAME, DEPARTMENT, SIZE, DOWNLOAD, MONTH, YEAR, ACC_STATUS, EMAIL) 
              VALUES ('$newfilename', '$foldername', '$size', '0', '$month', '$year', 'Admin', '$user')";
              mysqli_query($conn, $insertQueryDownload);

              $insertQueryUpload = "INSERT INTO upload_log (NAME, DEPARTMENT, SIZE, UPLOAD, MONTH, YEAR, ACC_STATUS, EMAIL) 
              VALUES ('$newfilename', '$foldername', '$size', '1', '$month', '$year', 'Admin', '$user')";

              mysqli_query($conn, $insertQueryUpload);

            echo "<script type='text/javascript'>
            document.querySelector('body').style.overflow = 'hidden';
            Swal.fire({
  icon: 'success',
  title: 'Sucessfully Upload File!!',
  text:'Your File Has Been Succesfully Upload and Sent to the User and Database!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
}).then(function(){
  ...
  confirmButtonColor:'#00396D',
   ...
   timer:3000
        ...
        $year = date("Y",strtotime("+0 HOURS"));
         ...
         if(!is_dir("../uploads/".$foldername)) mkdir("../uploads/".$foldername);
          if(move_uploaded_file($file,"../uploads/".$foldername."/".$filename)){
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$filename','$foldername', '$size','$description','$user', '$sendto', 0, '$time',0,'$designation', 'Admin', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
              ...
              $controlActionID= "CONTROL ID#: ".$controlno;
               ...
               $insertInNotification = "INSERT INTO notifcation_table (id, controlNumber, EMAIL, SENDTO, ACTION, FILENAME, TIMERS, SEEN_STATUS, LINK) 
              VALUES (0, '$controlActionID', '$email', '$sendto', 'Sent You a File With a Document Named', '$filename', '$time', 0, 'sharedwithme')";
              mysqli_query($conn, $insertInNotification);


              $insertQueryDownload = "INSERT INTO download_log (NAME, DEPARTMENT, SIZE, DOWNLOAD, MONTH, YEAR, ACC_STATUS, EMAIL) 
              VALUES ('$filename', '$foldername', '$size', '0', '$month', '$year', 'Admin', '$user')";
              mysqli_query($conn, $insertQueryDownload);

              $insertQueryUpload = "INSERT INTO upload_log (NAME, DEPARTMENT, SIZE, UPLOAD, MONTH, YEAR, ACC_STATUS, EMAIL) 
              VALUES ('$filename', '$foldername', '$size', '1', '$month', '$year', 'Admin', '$user')";
