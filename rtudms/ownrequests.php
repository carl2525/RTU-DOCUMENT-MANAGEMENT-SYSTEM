   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            ...
            <span>|</span>
            <span style="color: #E0A100;">MY REQUESTS</span>
          </h4>
<!-- 
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
         ...
         $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,STATUS,ACKNOWLEDGED FROM requests WHERE EMAIL ='$id' ORDER BY id DESC";
      ...
      if ($status== 'Done!'){
        echo "<a href='downloadrequest.php?file_id=$reqid' onclick='downloadYes(event)' class='btn btn-sm btn-outline-primary'><i class='fa fa-download'></i></a>";
      }
    ?>
     <script>
              ...
              document.querySelector("body").style.overflow = 'visible';
                   ...
                   <a href="deleterequests.php?ID=<?php echo  $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-trash"></i>
            <script>
              function yesNO(ev){
                document.querySelector("body").style.overflow = 'hidden';
                ev.preventDefault();
