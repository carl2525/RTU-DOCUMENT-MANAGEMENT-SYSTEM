...
if (isset($_POST['save'])) { // if save button on the form is clicked
    ...
    $linkname = 'RTU'.$codeprint.' - '.$_POST['linkname'];
    ...
    $query=mysqli_query($conn,"SELECT * FROM `upload_files` WHERE `NAME` = '$linkname'")or die(mysqli_error($conn));
       ...
       { 
        ...
        exit();
         ...
         date_default_timezone_set("asia/manila");
            ...
            $fh = fopen("../uploads/".$foldername."/"."$linkname.txt", "w");
            fwrite($fh, $content);
            fclose($fh);
            ...
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$linkname','$foldername','0','$description','$user', '$sendto', 0, '$time',0,'$designation', 'Admin', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
              ...
              VALUES (0, '$controlActionID', '$email', '$sendto', 'Sent You a Link', '$linkname', '$time', 0, 'sharedwithme')";
              ...
              VALUES ('$linkname', '$foldername', '0', '1', '$month', '$year', 'Admin', '$user')";
  ...
  text:'Your Link Has Been Succesfully Uploaded and Sent to the User and Database!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
}).then(function(){
