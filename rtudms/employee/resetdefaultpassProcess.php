...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <!--FORM-->
     ...
     <center><p class="mt-3 mb-4 h3 fw-bold">Change Default Password</p></center>

      <div class="form-floating mb-2 mt-2" >
      <input type="password" class="form-control" placeholder="Enter email"name="newpass" onChange="onChange()" id="pwd" required>
  <label for="email" id="emailph">Change Default Password</label>
   </div>
  ...
  <label for="email" id="emailph">Confirm New Password</label>
    ...
    <input type="checkbox" onclick="unmask()"> Show Password <br><br>
        ...
        <button type="button" class="float-start btn mb-3 col-6 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; " ><a href="unsetSessions.php" style="text-decoration: none; color:black;"><i class="fa fa-arrow-left"></i> Go Back</button></a>
        <button type="reset" class="float-end btn col-5 mb-3 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; " ><i class="fa fa-refresh"></i>   Reset</button>

        <button type="submit" name="submit" class="mt-0 btn col-12 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; ">Reset Password</button>
      </div>
