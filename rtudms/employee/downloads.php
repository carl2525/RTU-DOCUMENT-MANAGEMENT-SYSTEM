...
if (isset($_GET['file_id'])) {
    ...
    if (file_exists($filepath)) {
        ...
        VALUES ('$name', '$dep', '$size', '1', '$month', '$time', '$year', 'User', '$email')";
    ...
    if($fi['SIZE'] == 0){
        ...
        $filepath = "../../uploads/".$file['DEPARTMENT']."/".$link.".txt";
        ...
        if (file_exists($filepath)) {
            header('Content-Description: File Transfer');
            header('Content-Type: application/octet-stream');
            header('Content-Disposition: attachment; filename=' . basename("../../uploads/".$file['DEPARTMENT']."/".$link.".txt"));
            header('Expires: 0');
            header('Cache-Control: must-revalidate');
            header('Pragma: public');
            header('Content-Length: ' . filesize("../../uploads/".$file['DEPARTMENT']."/".$link.".txt"));
            readfile("../../uploads/".$file['DEPARTMENT']."/".$link.".txt");
