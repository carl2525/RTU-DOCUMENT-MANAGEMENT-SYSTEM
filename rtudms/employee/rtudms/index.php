...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <form class="login-form mt-4" action="admin_login.php" method="POST">
    ...
    <div class="form-floating mt-3 mb-3">
      ...
      <div class=" text-center form-floating mb-2">
        <br>
        <button name = "adminlog" id="login" type="submit" class=" btn col-5 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;">LOGIN</button>
      </div>
