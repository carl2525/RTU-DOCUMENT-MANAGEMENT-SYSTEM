...
<div class="container-fluid">
    ...
    <a href="ownrequests.php"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#view"></use></svg>View My Requests</button></a>
    <hr>
    </div>
  </div>
        ...
        <form action="requestsprocess.php" id="add_form" method="post" enctype="multipart/form-data">
          ...
          <div class="col-md-11">
              <div class="md-form mb-0 text-center ms-5">
                <input type="hidden" name="email" value="<?php echo ucwords(htmlentities($id)); ?>" class="form-control " readonly="">
