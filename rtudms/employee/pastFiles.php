...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="none">Filesize</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices == "all"){
          ...
          $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE YEAR < '$currentYear' AND ARCHIVE = '0' group by id asc";
          $result=mysqli_query($conn,$query);
      ...
      <?php  }
        ...
        WHERE (DEPARTMENT = '$offices' AND YEAR < $currentYear AND ARCHIVE = '0') GROUP BY id asc";
        $result=mysqli_query($conn,$query);
    ...
    <?php  } }
         ...
         $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE (DEPARTMENT = '$offices' AND YEAR < $currentYear AND ARCHIVE = '0') group by NAME desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['ID'];
          $controlid =  $file['controlNumber'];
    ...
    <?php  }
         ...
         $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE YEAR < $currentYear AND ARCHIVE = '0' group by NAME desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['ID'];
          $controlid =  $file['controlNumber'];
