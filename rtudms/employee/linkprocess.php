       ...
       { 
        ...
        exit();
         ...
         date_default_timezone_set("asia/manila");
            ...
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$linkname','$foldername','0','$description','$user', '$sendto', 0, '$time',0,'$designation', 'User', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
              ...
              VALUES ('$linkname', '$foldername', '0', '1', '$month', '$year', 'User', '$user')";
