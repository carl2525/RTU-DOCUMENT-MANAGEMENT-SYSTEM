...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <li>
        <a href="requestsfolder.php" class="nav-link text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
          Manage All Requests
        </a>
      </li>
...
<thead>
    ...
    <th class="desktop">Action</th>
     ...
     <?php
          ...
          $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,ACKNOWLEDGED,STATUS FROM requests ORDER BY TIMERS ASC";
        ...
        $sendto =  $file['SENDTO'];
         ...
         $acknowledged = $file['STATUS'];
            ...
            ?>      
             ...
             <tr>
          <td width="7%" class="fw-bold"><?php echo $reqid; ?></td>
