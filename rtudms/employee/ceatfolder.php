    ...
    <th class="none">Filesize</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices!="All"){
          ...
          $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE (DEPARTMENT= '$offices' AND YEAR = '$currentYear' AND ARCHIVE = '0') group by id asc";
          $result=mysqli_query($conn,$query);
          while($file=mysqli_fetch_array($result)){
            $id =  $file['controlNumber'];
           $name =  $file['NAME'];
           ...
           $year =  $file['YEAR'];
            ...
            ?>      
             ...
             <tr>
          <td width="3%" class="fw-bold"><?php echo $id; ?></td>
