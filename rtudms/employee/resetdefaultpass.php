...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <form method="post" class="login-form mt-4"  action="resetdefaultpassProcess.php"> 
  ...
  <label for="email" id="emailph">Confirm New Password</label>
    ...
    <input type="checkbox" onclick="unmask()"> Show Password <br><br>
        ...
        <button type="button" id="submitbtn1" class="float-start btn mb-3 col-6 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; "><a href="unsetSessions.php" style="text-decoration: none; color:black;"><i class="fa fa-arrow-left"></i> Go Back</button></a>
