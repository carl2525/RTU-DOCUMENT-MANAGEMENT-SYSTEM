...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
 ...
 <symbol id="right"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"/></svg></symbol>
     <symbol id="signout"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M160 96c17.7 0 32-14.3 32-32s-14.3-32-32-32H96C43 32 0 75 0 128V384c0 53 43 96 96 96h64c17.7 0 32-14.3 32-32s-14.3-32-32-32H96c-17.7 0-32-14.3-32-32l0-256c0-17.7 14.3-32 32-32h64zM504.5 273.4c4.8-4.5 7.5-10.8 7.5-17.4s-2.7-12.9-7.5-17.4l-144-136c-7-6.6-17.2-8.4-26-4.6s-14.5 12.5-14.5 22v72H192c-17.7 0-32 14.3-32 32l0 64c0 17.7 14.3 32 32 32H320v72c0 9.6 5.7 18.2 14.5 22s19 2 26-4.6l144-136z"/></svg></symbol>
      <symbol id="left"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"/></svg></symbol>
      ...
      <li>
        <a href="addfile.php" class="nav-link text-white">
          ...
          Add Document
               ...
               <li>
        <a href="ceatfolder.php" class="nav-link text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
          Manage All Files
        </a>
      </li>
   ...
   <div class="container-fluid mt-5 rounded-4 ">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
            <a href="dashboard.php" style="text-decoration: none; color:#10164D; ">HOME PAGE | MANAGE ALL FILES</a>
            <span>|</span>
            <span style="color: #E0A100;">ALL ARCHIVED DOCUMENTS</span>
          </h4>
<!-- 
...
<div class="d-flex">
  ...
  <form action="archiveFiles1.php" method="POST">
  <input class="" type="submit" id="changeDept" value="submit" name="department" style="display: none;">
  <select class="d-inline-block form-select fw-bold btn waves-effect waves-light pe-5 rounded-4 " onchange="folder(this.value);" name="offices" aria-label="Default select example" style="background-color: #E0A100;"><i class="fas fa-file-medical">
    <option value="" selected disabled>Choose Department</option>
    <option value="All">All Department</option>
 <?php
         require_once("connection.php");

        $query="SELECT OFFICES FROM department_office order by id asc";
        ...
        while($file=mysqli_fetch_assoc($result)){
         ...
         $offices = $file['OFFICES'];
          ...
          ?>    
    <option name="offices" value="<?php echo $offices; ?>"><?php echo $offices; ?></option>  <?php  } ?>
                    ...
                    <div class="form-group ps-2">
                        <div class="input-group">
                            ...
                            <a href="ceatfolder.php" class="text-black">
                                
                            <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 " style="background-color: #E0A100;"><svg class="" width="20" height="20"><use xlink:href="#left"/></svg>Back to Manage All Files</button>
                            </a>
                            </span>
                            <span class="input-group-btn">
                            <a href="pastFiles.php" class="text-black">
                            <button class="d-inline-block fw-bold btn waves-effect waves-light ms-2 rounded-4 " style="background-color: #E0A100;">Old Documents<svg class="" width="20" height="20"><use xlink:href="#right"/></svg></button>
                            </a>
                            </span>
                        </div>
                    </div>
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="Desktop">Uploader</th>
    <th class="desktop">Date/Time Upload</th>
    ...
    <th class="desktop">Action</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices!="All"){
          ...
          $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE ARCHIVE = '1' AND  DEPARTMENT= '$offices' group by ID DESC";
          $result=mysqli_query($conn,$query);
         ...
         $controlid =  $file['controlNumber'];
           ...
           $year =  $file['YEAR'];
            ...
            ?>      
             ...
             <tr>
          <td width="3%" class="fw-bold"><?php echo $controlid; ?></td>
          <td width="20%"><?php echo  $name; ?></td>
        <td width="8%"><?php echo $department; ?></td>
         <td width="10%"><?php echo $uploads; ?></td>
         <td width="10%"><?php echo $time; ?></td>
         <td width="5%"><?php echo $year; ?></td>
        <td width="5%"><?php echo $download; ?></td>
        <td width="5%"><?php echo floor($size / 1000) . ' KB'; ?></td>
        

                 <td width="8%">
          <a href='unarchive.php?file_id=<?php echo $id; ?>' onclick="downloadYes(event)" class="btn btn-sm btn-outline-primary"><i class="fa fa-upload"></i>
 <script>
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.isConfirmed) {
                   ...
                   <a href="delete1.php?ID=<?php echo  $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-trash"></i>
                   <script>
    function yesNO(ev) {
        document.querySelector("body").style.overflow = 'hidden';
        ev.preventDefault();
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                       ...
                       var password = result.value;
                        ...
                        if (password == pass) { // password checking $_SESSION["password"] if equal to user input 
                                                //(high risk (maybe) since lumulutang lang password ng user dahil super variable)
                                                
                            window.location.href = urlToRedirect;
                        } else {
                            // Show a warning message that the password is incorrect
                            Swal.fire({
    ...
    <?php  } }
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE ARCHIVE ='1' group by ID desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['ID'];
         $controlid =  $file['controlNumber'];
...
if (val === "") {
  ...
  document.getElementById('changeDept').click();
}
