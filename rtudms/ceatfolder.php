                    ...
                    <div class="form-group ps-2">
                        <div class="input-group">
                            ...
                            <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 " style="background-color: #E0A100;">Old Documents <svg class="" width="20" height="20"><use xlink:href="#right"/></svg></button>
                             ...
                             <span class="input-group-btn">
                            <a href="archiveFiles1.php" class="text-black">
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices!="All"){
          ...
          $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE (DEPARTMENT= '$offices' AND YEAR = '$currentYear' AND ARCHIVE = '0') ORDER BY id";
          $result=mysqli_query($conn,$query);
 ...
 <script>
    ...
    <?php  } }
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE (YEAR = '$currentYear' AND ARCHIVE = '0') ORDER BY id";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
           $id=  $file['ID'];
         $controlid =  $file['controlNumber'];
