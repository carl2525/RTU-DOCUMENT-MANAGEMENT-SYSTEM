...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="add"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M404.3 86l-202 202c-1.5 1.5-2.3 3.5-2.3 5.6v26.5c0 4.4 3.6 7.9 7.9 7.9h26.3c2.1 0 4.2-.8 5.7-2.3l202.1-202c3.1-3.1 3.1-8.1 0-11.2L415.5 86c-3.1-3.1-8.1-3.1-11.2 0zM475.6 67l-14.4-14.4-.2-.2c-3.1-2.7-7.2-4.4-11.5-4.4-4.4 0-8.5 1.7-11.6 4.5l-11.3 11.4c-1.5 1.6-1.5 4.1 0 5.6L437 79.9l21.7 21.7c1.6 1.6 4.1 1.6 5.7 0l11.3-11.3c2.8-3.1 4.4-7.1 4.4-11.6-.1-4.4-1.7-8.6-4.5-11.7z"></path><g><path d="M250 342c-3 3-7.1 4.7-11.3 4.7H197.3c-8.8 0-16-7.2-16-16V289.2c0-4.2 1.7-8.3 4.7-11.3l.8-.8 147.6-147.6c2.5-2.5.7-6.8-2.8-6.8H90.7C58.3 122.7 32 149 32 181.4v224c0 32.4 26.3 58.7 58.7 58.7h256c32.4 0 58.7-26.3 58.7-58.7v-209c0-3.6-4.3-5.3-6.8-2.8L250.8 341.2l-.8.8z"></path></g></svg></symbol>
...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <li>
        ...
        <a href="requestsfolder.php" class="nav-link dropdown-item text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - All Request
        </a></li>
        <li>
   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            <a href="dashboard.php" style="text-decoration: none; color:#10164D; ">HOME PAGE | MANAGE</a>
            <span>|</span>
            <span style="color: #E0A100;">ALL REQUESTS</span>
          </h4>
<!-- 
...
<div class="d-flex">
                    ...
                    <form action="requestsfolder.php" method="POST">
    ...
    <option name="offices" value="<?php echo $offices; ?>"><?php echo $offices; ?></option>  <?php  } ?>
                    ...
                    <div class="form-group ps-2">
                        <div class="input-group">
                            ...
                            <a href="add_requests.php"><button type="button" class=" ms-1 btn btn-success waves-effect rounded-4 waves-light"><svg class="" width="20" height="20"><use xlink:href="#add"></use></svg>Create Requests</button></a>
...
<thead>
    ...
    <th class="desktop">Action</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices == "All"){
          ...
          $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,ACKNOWLEDGED FROM requests group by id desc";
          $result=mysqli_query($conn,$query);
        ...
        $sendto =  $file['SENDTO'];
         ...
         $acknowledged = $file['ACKNOWLEDGED'];
            ...
            ?>      
             ...
             <tr>
          <td width="3%" class="fw-bold"><?php echo $reqid; ?></td>
          <td width="3%"><?php echo $department; ?></td>
        <td width="20%"><?php echo $request; ?></td>
         <td width="10%"><?php echo $sendto; ?></td>
         <td width="10%"><?php echo $email; ?></td>
         <td width="10%"><?php echo $time; ?></td>
        <td width="5%"><?php echo $acknowledged; ?></td>
        
                   <td width="10%">
                   <a href="deleterequests.php?ID=<?php echo  $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-archive"></i>
 <script>
              function yesNO(ev){
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    swalWithBootstrapButtons.fire(
                      'Cancelled!',
                      'Your File is Safe and Didnt Archive.',
                      'error'
                    )
      ...
      <?php  }
        ...
        $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,ACKNOWLEDGED FROM requests WHERE DEPARTMENT = '$offices' group by id desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['id'];
          $reqid =  $file['REQUESTID'];
 ...
 <script>
    ...
    <?php  } }
        ...
        $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,ACKNOWLEDGED FROM requests ORDER BY id desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['id'];
          $reqid =  $file['REQUESTID'];
 ...
 <script>
    ...
    <?php  }
         ...
         $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,STATUS FROM requests group by id asc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
          $id =  $file['id'];
          $reqid =  $file['REQUESTID'];
