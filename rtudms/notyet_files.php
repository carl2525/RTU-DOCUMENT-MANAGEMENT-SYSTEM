...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
        ...
        <li>
        <a href="notyet_files.php" class="nav-link dropdown-item text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Not Yet Seen Files
        </a></li>
        <li>
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="description">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE (EMAIL ='$id' AND DOWNLOAD ='0' AND SENDTO!='Private' AND ARCHIVE ='0')  ORDER by ID DESC";
