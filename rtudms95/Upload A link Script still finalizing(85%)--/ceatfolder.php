   ...
   <div class="container-fluid mt-5 rounded-4 ">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold">
            ...
            <span>|</span>
            <span style="color: #E0A100;">ALL DOCUMENTS</span>
          </h4>
<!-- 
...
<div class="d-flex">
                    ...
                    <form action="ceatfolder.php" method="POST">
    ...
    <option name="offices" value="<?php echo $offices; ?>"><?php echo $offices; ?></option>  <?php  } ?>
                    ...
                    <div class="form-group ps-2">
                        <div class="input-group">
                            ...
                            <button class="d-inline-block fw-bold btn waves-effect waves-light rounded-4 " style="background-color: #E0A100;">Old Documents <svg class="" width="20" height="20"><use xlink:href="#right"/></svg></button>
                            </a>
                            </span>
                             <span class="input-group-btn">
                            <a href="archiveFiles.php" class="text-black">
                            <button class="d-inline-block fw-bold btn waves-effect waves-light ms-2 rounded-4 " style="background-color: #E0A100;">Archived Documents</button>
                            </a>
                            </span>
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     if(isset($_POST['department'])){
        ...
        if($offices!="All"){
          ...
          $query="SELECT DISTINCT ID,controlNumber,NAME,DESCRIPTION,DEPARTMENT,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE (DEPARTMENT= '$offices' AND YEAR = '$currentYear' AND ARCHIVE = '0') group by ID DESC";
          $result=mysqli_query($conn,$query);
      ...
      if ($size = '0'){
        echo "<a href='archive.php?id={$id}'class='btn btn-sm btn-outline-danger'><i class='fa fa-reply'></i></a>";
 ...
 <script>
    ...
    <?php  } }
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DESCRIPTION,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,YEAR,DOWNLOAD,SIZE FROM upload_files WHERE YEAR = '$currentYear' AND ARCHIVE = '0' group by ID desc";
        $result=mysqli_query($conn,$query);
        while($file=mysqli_fetch_array($result)){
           $id=  $file['ID'];
         $controlid =  $file['controlNumber'];
