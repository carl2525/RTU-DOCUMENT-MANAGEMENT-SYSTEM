...
<span>
<p class="mt-0 mb-2 pt-0 pb-0"><i>Document or Link<i></p>
  <select style="text-align-last:center;" class="form-select fw-bold w-25 rounded-3 mb-2" id="customOffice" name="department" aria-label="Default select example" onchange="uploadType(this.value);">
                      <option selected value="document">Upload a Document</option>
...
<div id="uploadCard" class=" card rounded-4 border-bottom border-top border-5">
...
<div class="input-group">
  ...
  <input type="file" class="form-control fw-bold rounded-3" id="myFileUpload" name="myfile[]" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" multiple required>
...
<div class="col-md-10 mt-2">
 ...
 <center>
 <div class="col-md-10 mt-2">
 <input type="text" style="display: none;" class="form-control rounded-3" name="linkname" id="linknam" placeholder="Enter Link Name">
 <div>
  </center>
...
<div class="footerstyleUpload">
    ...
    <footer class="ms-0 w-100 py-5   mb-5 border-top border-5 border-warning mt-5 " id="footerSize">
...
if (val === "link") {
  ...
  document.getElementById("add_form").setAttribute("action","linkprocess.php");
  document.getElementById("myFileUpload").removeAttribute("required");
 document.getElementById("myFileUpload").style.display = 'none';
 document.getElementById("exampleFormControlTextarea1").setAttribute("required","");
 document.getElementById("exampleFormControlTextarea1").setAttribute("placeholder","Enter Document Link");
 document.getElementById("warnings").style.visibility="hidden";
 document.getElementById("linknam").style.display="block";
} 

if (val === "document"){
   document.getElementById("add_form").setAttribute("action","fileprocess.php");
  document.getElementById("myFileUpload").setAttribute('required', '');
  document.getElementById("myFileUpload").style.display = 'block';
  document.getElementById("exampleFormControlTextarea1").removeAttribute("required");
  document.getElementById("exampleFormControlTextarea1").setAttribute("placeholder","Enter Description Message");
  document.getElementById("warnings").style.visibility="visible";
  document.getElementById("linknam").style.display="none";
}
