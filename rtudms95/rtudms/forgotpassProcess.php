...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <label for="email" id="emailph" textContent="">Confirm New Password</label>
    ...
    <input type="checkbox" onclick="unmask()"> Show Password <br><br>
        ...
        <button type="button" id="submitbtn1" class="float-start btn mb-4 col-10 text-dark btn-floating rounded-3 font-weight-bold" style="background:#9B9B9B; font-weight:bold; " textContent=""><a href="unsetSessions.php" style="text-decoration: none; color:black;"><i class="fa fa-arrow-left"></i> Go Back</button></a>
