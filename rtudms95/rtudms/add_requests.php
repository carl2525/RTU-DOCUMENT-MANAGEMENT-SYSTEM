...
<div class="container-fluid">
    ...
    <a href="addrequests.php"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#view"></use></svg>View All Requests</button></a>
