...
<svg class="" width="20" height="20"><use xlink:href="#edit"/></svg></a> |  <a href="delete_user.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;"><use xlink:href="#trash"/></svg>
 <script>
              function yesNO(ev){
               ...
               const swalWithBootstrapButtons = Swal.mixin({
                ...
                swalWithBootstrapButtons.fire({
                  ...
                  if (result.isConfirmed) {
                    ...
                    swalWithBootstrapButtons.fire(
                      'Cancelled!',
                      'Your User Account is Safe and Didnt Delete.',
                      'error'
                    )
