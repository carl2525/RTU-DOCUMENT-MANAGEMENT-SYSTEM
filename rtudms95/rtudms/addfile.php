   ...
   <div class="container-fluid mt-5 rounded-4 ">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
            ...
            <span>|</span>
            <span style="color: #E0A100;">ADD DOCUMENT</span>
          </h4>
<!-- 
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE ARCHIVE = '0' ORDER by ID DESC";
