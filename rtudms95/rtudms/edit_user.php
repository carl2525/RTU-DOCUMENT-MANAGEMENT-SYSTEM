...
<svg class="" data-toggle="modal" data-target="#modalRegisterFormss" width="20" height="20"><use xlink:href="#edit"/></svg></a> |  <a href="delete_user.php?id=<?php echo htmlentities($rs['id']); ?>" onclick="yesNO(event)"><svg class="" width="20" height="20" style="color:red; cursor: hand;"><use xlink:href="#trash"/></svg>
             <script>
              function yesNO(ev){
...
$q = mysqli_query($conn,"SELECT * from login_user where id = '$idname'") or die (mysqli_error($conn));
  ...
  <div class="modal-dialog rounded-5" role="document">
    ...
    <div class="modal-content rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold rounded-4"><svg class="" width="32" height="32"><use xlink:href="#edit"/></svg> EDIT USER ACCOUNT</h4>
        ...
        <div class="form-floating mb-3">
          <input type="email" id="orangeForm-email" placeholder="Enter New Email" name="email_address" value="<?php echo $admin1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#email"/></svg>    Update Email</label>
        </div>
        <div class="form-floating mb-3">
          <input type="password" id="orangeForm-pass" placeholder="Ente" name="user_password" value="<?php echo $pass1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#lock"/></svg>   Update Password</label>
        </div>
          <div class="form-floating mb-3">
          <input type="text" id="orangeForm-pass" name="status" placeholder="Current Status" value = "<?php echo $status;?>" class="form-control validate rounded-4" readonly="">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#users"/></svg>    Current Status</label>
        </div>
      
      </div>
      <div class="modal-footer d-flex justify-content-center">
        <button class="btn btn-warning fw-bold rounded-4" name="edit2">UPDATE ACCOUNT</button>
      </div>
    </div>
  </div>
</div>
