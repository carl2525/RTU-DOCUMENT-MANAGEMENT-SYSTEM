...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT id,REQUESTID,DEPARTMENT,REQUEST,SENDTO,TIMERS,EMAIL,STATUS,ACKNOWLEDGED FROM requests WHERE EMAIL!='$id' AND ACKNOWLEDGED='0' AND SENDTO ='$id' ORDER BY id DESC";
