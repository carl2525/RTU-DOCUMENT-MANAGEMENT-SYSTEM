...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="trash"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="2em" width="2em" xmlns="http://www.w3.org/2000/svg"><path d="M160 400C160 408.8 152.8 416 144 416C135.2 416 128 408.8 128 400V192C128 183.2 135.2 176 144 176C152.8 176 160 183.2 160 192V400zM240 400C240 408.8 232.8 416 224 416C215.2 416 208 408.8 208 400V192C208 183.2 215.2 176 224 176C232.8 176 240 183.2 240 192V400zM320 400C320 408.8 312.8 416 304 416C295.2 416 288 408.8 288 400V192C288 183.2 295.2 176 304 176C312.8 176 320 183.2 320 192V400zM317.5 24.94L354.2 80H424C437.3 80 448 90.75 448 104C448 117.3 437.3 128 424 128H416V432C416 476.2 380.2 512 336 512H112C67.82 512 32 476.2 32 432V128H24C10.75 128 0 117.3 0 104C0 90.75 10.75 80 24 80H93.82L130.5 24.94C140.9 9.357 158.4 0 177.1 0H270.9C289.6 0 307.1 9.358 317.5 24.94H317.5zM151.5 80H296.5L277.5 51.56C276 49.34 273.5 48 270.9 48H177.1C174.5 48 171.1 49.34 170.5 51.56L151.5 80zM80 432C80 449.7 94.33 464 112 464H336C353.7 464 368 449.7 368 432V128H80V432z"/></svg></symbol>
   ...
   <symbol id="plane"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="15em" width="30em" xmlns="http://www.w3.org/2000/svg"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM218 271.7L64.2 172.4C66 156.4 79.5 144 96 144H352c16.5 0 30 12.4 31.8 28.4L230 271.7c-1.8 1.2-3.9 1.8-6 1.8s-4.2-.6-6-1.8zm29.4 26.9L384 210.4V336c0 17.7-14.3 32-32 32H96c-17.7 0-32-14.3-32-32V210.4l136.6 88.2c7 4.5 15.1 6.9 23.4 6.9s16.4-2.4 23.4-6.9z"/></svg></symbol>
...
<div class="container-fluid">
  ...
  <div class="col-md-12 float-start" style="position: relative;">
    <div class="container-fluid">
 ...
 <table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT * FROM upload_files WHERE (EMAIL ='$id' AND SENDTO ='Private' AND ARCHIVE ='0') group by ID DESC";
              ...
              function downloadYes(evs){
                ...
                window.location.href=urlToRedirect;
                  ...
                  timer: 7000
                   ...
                   <a href="delete.php?ID=<?php echo  $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-trash"></i>
            <script>
              function yesNO(ev){
                ev.preventDefault();
...
?>
  <div class="modal-dialog border-bottom border-top border-5 rounded-4" role="document">
    <form method="POST" action="shareProcess.php">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold"><svg class="" width="32" height="32"><use xlink:href="#edit"/></svg> SEND FILE TO USER</h4>
        ...
        <div class="form-floating mb-3">
          <input type="text" id="orangeForm-name" name="name" placeholder="Enter New Name" value="<?php echo $fname1;?>" readonly class="form-control validate ms-0">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#"/></svg>    File Name</label>
        </div>
                <div class="form-floating mb-3">
            <textarea class="form-control" id="exampleFormControlTextarea1" name="description" rows="4" placeholder="Enter Description Message" style="height: 150px; resize: none;"></textarea>
 ...
 <?php
        ...
        $query="SELECT NAME FROM login_user WHERE NAME!='$username'";
        $result=mysqli_query($conn,$query);
    ...
    <option  name="sentuser" value="<?php echo $sendUser; ?>">Send to <?php echo $sendUser; ?></option>  <?php  } ?>
      ...
      <div class="modal-footer d-flex justify-content-center">
        <button class="btn btn-warning fw-bold" name="edit">SHARE FILE</button>
      </div>
    </div>
  </div>
</div>
...
<?php
 ...
 if(isset($_POST['edit'])){
    ...
    $control= mysqli_real_escape_string($conn,$_POST['controlNumber']);
    $fileName= mysqli_real_escape_string($conn,$_POST['filename']);

    $controlNotif = "CONTROL ID#: ".$control;

    date_default_timezone_set("asia/manila");
    $time = date("Y/m/d H:i:s",strtotime("+0 HOURS"));

     $conn->query("UPDATE `upload_files` SET `DESCRIPTION` = '$description', `SENDTO` = '$sendTo', `SEEN_STATUS` = '0' WHERE `id` = '$_REQUEST[id]'") or die(mysqli_error($conn));

    $conn->query("UPDATE `notifcation_table` SET `SENDTO` = '$sendTo',`ACTION` = 'Shared The Private File to You',`TIMERS` = '$time', `SEEN_STATUS` = '0' WHERE (`controlNumber` = '$controlNotif' AND `SENDTO` = 'Private' AND `EMAIL` = '$idemail' AND `FILENAME` = '$fileName')") or die(mysqli_error($conn));
  ...
  icon: 'success',
  title: 'Success!!',
  text:'The Document Has Been Successfully Shared',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
}).then(function(){
          window.location='privateFiles.php'
          })
