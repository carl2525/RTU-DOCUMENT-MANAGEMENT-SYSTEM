...
<table id="dtable" class = "table table-striped w-100" >
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT controlNumber,ID,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE (EMAIL!='$id' AND ARCHIVE = '0' AND (SENDTO='All' OR SENDTO = '$id')) OR (EMAIL='$id' AND SENDTO ='$id' AND ARCHIVE='0')  group by ID DESC";
