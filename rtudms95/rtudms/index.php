...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    <img src="../assets/img/rtudms1.png" class="img-fluid mt-3" title="e-RTU" alt="e-RTU"><hr class="mb-3">
    ...
    <div class=" text-center form-floating mb-2">
        ...
        <button type="button" onclick="chooseLogin_employee()" id="loginEmploy" class=" btn col-5 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;">Employee   <i class="fa fa-sign-in" aria-hidden="true"></i></button>

        <button type="button" onclick="chooseLogin_admin()" id="loginAdmin" class=" btn col-5 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold;">Admin   <i class="fa fa-sign-in" aria-hidden="true"></i></button>
      </div>
    ...
    <div id="pwdDiv" class="form-floating mt-3 mb-3" style="display: none; position: absolute;">
      ...
      <a href="forgotPass.php" class="mt-2" id="forgotpass" style="display:none">  Forgot Admin Password?</a>
    </div>

      
    <div class="form-floating mb-4">
        <button type="button" onclick="goback()" id="submitbtn1" class="float-start btn mb-3 col-6 text-dark btn-floating rounded-3 font-weight-bold" style="background:#9B9B9B; font-weight:bold; display: none; " textContent=""><i class="fa fa-arrow-left"></i> Go Back</button>
        <button type="reset" id="resetbtn" class="float-end btn col-5 mb-3 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; display: none;" textContent=""><i class="fa fa-refresh"></i>   Reset</button>

        <button type="submit" id="submitbtn" class="mt-0 btn col-12 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; display:none" textContent=""></button>
      </div>
...
function chooseLogin_employee() {
  ...
  element.innerHTML = "Employee Login &#10149;";

  document.getElementById("emailph").textContent = "Employee Email";
  document.getElementById("passwordph").textContent = "Employee Password ";

  document.getElementById("email").name = "email_address";
  document.getElementById("pwd").name = "user_password";
  document.getElementById("form").action = "employee/login.php";
...
document.getElementById("form").action = "admin_login.php";
