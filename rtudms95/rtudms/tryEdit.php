...
<div class="row ms-0 w-100" style="position: relative;">
 ...
 <div class="col-md-12 headertop ms-0 float-end rounded-4">
...
<div class="container-fluid">
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#modalRegisterForm"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#userPlus"/></svg>   Add Employee Account</button></a>
    <hr>
    </div>
  </div>
 ...
 <table id="dtable" class = "table table-striped w-100">
          ...
          <thead>
              ...
              <th clalss="desktop">Designation</th>
          ...
          ?>       
           ...
           <tr>
              <td width='5%' class="fw-bold"><?php echo $idname; ?></td>
               ...
               <td width='20%'><?php echo $rs['designation']; ?></td>
...
$q = mysqli_query($conn,"SELECT * FROM `admin_login` WHERE id = '$idname'") or die (mysqli_error($conn));
...
?>
  <div class="modal-dialog rounded-5" role="document">
    <form method="POST" action="editAdminProcess.php">
    <div class="modal-content rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold rounded-4"><svg class="" width="32" height="32"><use xlink:href="#edit"/></svg> EDIT ADMIN ACCOUNT</h4>
        ...
        <div class="form-floating mb-3">
          <input type="text" id="orangeForm-name" name="name" placeholder="Enter New Name" value="<?php echo $fname1;?>" class="form-control validate ms-0 rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#user"/></svg>    Update Name</label>
        </div>
        <div class="form-floating mb-3">
          <input type="email" id="orangeForm-email" placeholder="Enter New Email" name="admin_user" value="<?php echo $admin1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#email"/></svg>    Update Email</label>
        </div>
        <div class="form-floating mb-3">
          <input type="password" id="orangeForm-pass" placeholder="Ente" name="admin_password" value="<?php echo $pass1;?>" class="form-control validate rounded-4">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#lock"/></svg>   Update Password</label>
        </div>
          <div class="form-floating mb-3">
          <input type="text" id="orangeForm-pass" name="admin_status" placeholder="Current Status" value = "<?php echo $status;?>" class="form-control validate rounded-4" readonly="">
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#users"/></svg>    Current Status</label>
        </div>
      
      </div>
      <div class="modal-footer d-flex justify-content-center">
        <button class="btn btn-warning fw-bold rounded-4" name="edit">UPDATE ACCOUNT</button>
      </div>
    </div>
  </div>
</div>
