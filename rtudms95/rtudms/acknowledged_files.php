...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
        ...
        <li>
        <a href="acknowledged_files.php" class="nav-link dropdown-item text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Acknowledged Files
        </a></li>
        <li>
   ...
   <div class="container-fluid mt-5 rounded-4 ">
      ...
      <div class="card mb-4 wow fadeIn rounded-4 ">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4 ">
            ...
            <span>|</span>
            <span style="color: #E0A100;">ACKNOWLEDGE FILES</span>
          </h4>
<!-- 
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="none">Acknowledge Time: </th>
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,TIMEDOWNLOAD,DOWNLOAD FROM upload_files WHERE (EMAIL ='$id' AND DOWNLOAD >'0' AND ARCHIVE ='0' AND SENDTO!='Private') group by ID DESC";
        ...
        $sendto =  $file['SENDTO'];
         $time =  $file['TIMERS'];
         $timedownload= $file['TIMEDOWNLOAD'];
         $download =  $file['DOWNLOAD'];


       $date1 = new DateTime("$time");
      $date2 = new DateTime("$timedownload");
         $acknowledged_time = $date1 ->diff($date2);

        $format = $acknowledged_time ->format('about %d Days %h Hours %I Minutes %S Seconds ');
