   ...
   <div class="container-fluid mt-5 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            ...
            <span>|</span>
            <span style="color: #E0A100;">FILE HISTORY</span>
          </h4>
<!-- 
...
<div class="container-fluid">
   ...
   <a href="ownfiles.php"><button type="button" class=" ms-1 btn btn-success waves-effect rounded-4 waves-light"><svg class="" width="20" height="20"><use xlink:href="#add"></use></svg>Go Back to My Upload Files</button></a>
    <hr>
    </div>
  </div>
  <div class="col-md-12">
...
<table id="dtable" class = "table table-striped w-100">
          ...
          <thead>
     <th class="all" data-priority="1">ID</th>
    <th class="all" data-priority="2">Filename</th>
    <th class="all"data-priority="3">Folder</th>
    <th class="desktop" data-priority="4">Description</th>
    <th class="desktop" data-priority="5">Originated By</th>
    <th class="none" data-priority="6">Designation</th>
    <th class="desktop" data-priority="7">Date/Time Upload</th>
    <th class="none" data-priority="8">Send by</th>
    <th class="none" data-priority="9">Send to</th>
    <th class="none" data-priority="10">FileSize</th>
          </thead>
          <tbody>
     <?php

     $control_id = mysqli_real_escape_string($conn,$_GET['file_id']);

         require_once("connection.php");


        $query="SELECT * FROM send_history WHERE controlNumber='$control_id' order by TIMERS DESC ";
