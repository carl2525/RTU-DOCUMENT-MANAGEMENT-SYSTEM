  ...
  $query=mysqli_query($conn,"SELECT NAME FROM `upload_files` WHERE `NAME` = '$filename '")or die(mysqli_error($conn));
       ...
       if(!is_dir("../uploads/".$foldername)) mkdir("../uploads/".$foldername);
          if(move_uploaded_file($file,"../uploads/".$foldername."/".$newfilename)){
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$newfilename','$foldername', '$size','$description','$user', 'Requested', 0, '$time',0,'$designation', 'Admin', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
             ...
             $controlActionID= "CONTROL ID#: ".$controlno;
              ...
              VALUES (0, '$controlActionID', '$email', '$requestvalidate', 'Acknowledged Your Request and Send you File Named', '$filename', '$time', 0, 'privatefiles')";
        ...
        $time = date("Y/m/d H:i:s",strtotime("+0 HOURS"));
         ...
         if(!is_dir("../uploads/".$foldername)) mkdir("../uploads/".$foldername);
          if(move_uploaded_file($file,"../uploads/".$foldername."/".$filename)){
            $sql = "INSERT INTO upload_files (controlNumber,NAME, DEPARTMENT, SIZE, DESCRIPTION, SENTBY, SENDTO, DOWNLOAD, TIMERS,TIMEDOWNLOAD, DESIGNATION, ADMIN_STATUS, EMAIL, YEAR, SEEN_STATUS, ARCHIVE) VALUES ('$controlno','$filename','$foldername', '$size','$description','$user', 'Requested', 0, '$time',0,'$designation', 'Admin', '$user', '$year',0,0)";
            if (mysqli_query($conn, $sql)) {
             ...
             $controlActionID= "CONTROL ID#: ".$controlno;
              ...
              $insertQueryUpload = "INSERT INTO upload_log (NAME, DEPARTMENT, SIZE, UPLOAD, MONTH, TIME, YEAR, ACC_STATUS, EMAIL) 
              VALUES ('$filename', '$foldername', '$size', '1', '$month', '$timeupload', '$year', 'Admin', '$user')";
