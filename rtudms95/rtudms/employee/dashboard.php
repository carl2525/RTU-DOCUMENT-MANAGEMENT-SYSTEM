      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <div class="card-body d-md-flex justify-content-between shadow bg-light rounded-4">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1 fw-bold" rounded-4>
            ...
            <span>|</span>
            <span style="color: #E0A100;">DASHBOARD</span>
          </h4>
<!-- 
...
<div class="container-fluid rounded-4" style="visibility: hidden; display: none;" id="piechart_download">
        <div class="card mb-4 shadow bg-light rounded-4">
                      ...
                      <div class="card-body rounded-4">
                        <div>
                        <canvas id="pieChart1" style="height: 162px;"></canvas>
                      </div>
...
<div class="container-fluid col-md-12 rounded-4" id="piechart_upload">
        <div class="card mb-4 shadow bg-light rounded-4">
                      ...
                      <div class="card-body rounded-4">
                        <div>
                        <canvas id="pieChart" style="height: 162px;"></canvas>
                      </div>

                       <button class="float-end btn btn-outline-warning btn-sm rounded-3" id="btnHide" style="">
                           <i class="fa fa-eye-slash"></i>
                         </button>
              ...
              <?php
                    ...
                    //  }else{
                       ...
                       require_once("connection.php");
                             ...
                             $sql ="SELECT *,count(DEPARTMENT) as count FROM upload_files group by DEPARTMENT;";
                    ...
                    ?>
                <CENTER><h3 class="page-header fw-bold" >Count Upload | Department</h3></CENTER>  
            ...
            <div class=" ms-0 card-body rounded-4">
              ...
              <?php
                    ...
                    //  }else{
                       ...
                       require_once("connection.php");
							$sql ="SELECT *,SUM(DOWNLOAD) as count FROM upload_files group by DEPARTMENT;";
                             $result = mysqli_query($conn,$sql);
                    ...
                    ?>
                <CENTER><h3 class="page-header fw-bold" >Count Download | Department</h3></CENTER>  
  ...
  <div class="modal-dialog modal-dialog-centered border-bottom border-top border-5 rounded-4" role="document">
    <div class="modal-content bg-light">
      ...
      <div class="modal-body">
        ...
        <select class="form-select " aria-label="Default select example" required name="user_status" onmousedown="this.value='';" onchange="userType(this.value);">
