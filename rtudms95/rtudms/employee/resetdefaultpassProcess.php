...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    <img src="../../assets/img/rtudms1-defaultpass.png" class="img-fluid mt-3" title="e-RTU" alt="e-RTU">
    <hr class="mb-2">
    ...
    <form method="post" class="login-form mt-3"  action="resetdefaultpassProcess.php"> 
    <h5 class="mt-1 ms-2">Enter New Password</h5>
  ...
  <label for="email" id="emailph">Enter New Password</label>
   </div>


      <div class="form-floating mb-2 mt-2" >
      <input type="password" class="form-control" placeholder="Enter email"name="confirmpass" onChange="onChange()" id="pwd1" required>
  <label for="email" id="emailph">Confirm New Password</label>
   </div>

    <input type="checkbox" onclick="unmask()"> Show Password <br><br>
             <div class="form-floating mb-0">
        <button type="submit" id="submitbtn" name="submit" class="mt-0 mb-3 btn col-12 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; ">Reset Password <i class="fa fa-arrow-right"></i></button>
        <a href="unsetSessions.php" style="text-decoration: none; color:black;"><button type="button" id="submitbtn1" class="float-start btn mb-4 col-10 text-dark btn-floating rounded-3 font-weight-bold" style="background:#9B9B9B; font-weight:bold; "><i class="fa fa-arrow-left"></i> Go Back</button></a>
        <button type="reset" id="resetbtn" class="btn btn-outline-warning float-end col-2 mb-4 text-dark rounded-3 font-weight-bold" style="font-weight:bold; "><i class="fa fa-refresh"></i></button>
      </div>
    </form>
...
if($_POST["newpass"] === $_POST["confirmpass"]){
      ...
      $query = ("UPDATE `login_user` SET `user_password` = '$user_password' WHERE `login_user`.`email_address` = '$email'");
  ...
  text:'The Default Password Has Been Succesfully Change and Confirmed. Please Login Again!!',
  ...
  text:'Please Check Your Password Properly!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
...
include "sweetAlert.php";
         echo "<script type='text/javascript'>Swal.fire({
  icon: 'error',
  title: 'Two Password is Mismatch',
  text:'Please Check Your Password Properly!!',
  confirmButtonColor:'#00396D',
   confirmButtonText: 'Okay',
   timer:3000
