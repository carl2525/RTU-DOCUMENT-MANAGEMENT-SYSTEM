  ...
  confirmButtonColor:'#00396D',
   ...
   timer:2500
			  ...
			  if(password_verify($password, $row["user_password"]))  
                 {
           $resetpass = mysqli_query($conn,"SELECT * FROM newlycreatedadmin WHERE email ='$username'")or die(mysqli_error($conn));
...
<div id="carouselExampleIndicators" class="col-6 carousel slide" data-bs-ride="true" style="margin-top:-171px;">
  ...
  <div class="container login-sec">
    ...
    <div id="emailDiv" class="form-floating mb-2 mt-2" style="display: block;">
      ...
      <label for="email" id="emailph" textContent="">Employee Email</label>
    </div>
    ...
    <div id="pwdDiv" class="form-floating mt-3 mb-3" style="display: block;">
      ...
      <label for="pwd" id="passwordph" textContent="">Employee Password</label>
    </div>
    ...
    <div class="form-floating mb-4">
        ...
        <button type="submit" id="submitbtn" class="mt-0 btn col-12 text-dark btn-floating rounded-3 font-weight-bold" style="background:#E0A100; font-weight:bold; display: block;" textContent="">Employee Login &#8680;</button>
      </div>
