...
<html lang="en">
  ...
  <script src="medias/css/sweetalert2.min.js"></script>
...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
        ...
        <li>
        <a href="ownfiles.php" class="nav-link dropdown-item text-white active">
...
<div class="content">
<div class="row ms-0 mt-5 w-100" style="position: relative;">
   ...
   <div class="container-fluid mt-0 rounded-4">
      ...
      <div class="card mb-4 wow fadeIn rounded-4">
        ...
        <h4 class="mb-2 mb-sm-0 pt-1 fw-bold rounded-4">
            ...
            <span>|</span>
            <span style="color: #E0A100;">MY UPLOAD FILES</span>
          </h4>
<!-- 
...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE (EMAIL ='$id' AND SENDTO !='Private' AND ARCHIVE ='0') group by NAME DESC";
      ...
      <td><?php echo $download; ?></td>
                 ...
                 <td>
                  <a href="history.php?file_id=<?php echo $controlid;?>" class="btn btn-sm btn-outline-success"><i class="fa fa-list"></i></a>
...
<script type="text/javascript" src="https://cdn.datatables.net/v/dt/jq-3.6.0/dt-1.12.1/r-2.3.0/rr-1.2.8/datatables.min.js"></script>
  ...
  <div class="modal fade rounded-5" id="modalRegisterForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered rounded-4" role="document">
    <div class="modal-content bg-light rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold rounded-5" style="color: #10164D;"><svg class="" width="32" height="32"><use xlink:href="#userPlus"/></svg> ADD EMPLOYEE ACCOUNT</h4>
      ...
      <div class="modal-body">
        ...
        <select class="form-select rounded-4 " aria-label="Default select example" name="user_status"  onchange="userType(this.value);">
    ...
    <div class="form-floating mb-3">
      ...
      <div class="modal-footer d-flex justify-content-center rounded-4" id="reg" >
        <button class="btn btn-warning fw-bold"  name="reg">CREATE ADMIN ACCOUNT </button>
      </div>

      <div class="modal-footer d-flex justify-content-center rounded-4" id="reguser" style="visibility: hidden; position: absolute;">
