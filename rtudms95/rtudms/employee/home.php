...
?>
      ...
      <div class="col-md-3  ms-0 rounded-4">
...
<div class="col-md-9 ms-0 mb-3 rounded-4" id="upload">
     ...
     <div class="ms-0 card shadow bg-light rounded-4">
            <!--Card content-->
            <div class=" ms-0 card-body rounded-4">
              ...
              <?php
                    ...
                    ?>
                <CENTER><h3 class="page-header fw-bold rounded-4" >Monthly Upload | Report</h3></CENTER>  
...
<div class="col-md-9 ms-0 mb-3 rounded-4" id="download" style="visibility: hidden; position: absolute;">
     ...
     <div class="ms-0 card shadow bg-light rounded-4">
            ...
            <?php
                    ...
                    ?>
                <CENTER><h3 class="page-header fw-bold rounded-4" >Monthly Download | Report</h3></CENTER>  
  ...
  <div class="modal-dialog modal-dialog-centered border-bottom border-top border-5 rounded-4" role="document">
    <div class="modal-content bg-light">
      ...
      <div class="modal-body">
        ...
        <select class="form-select " aria-label="Default select example" required name="user_status" onchange="userType(this.value);">
