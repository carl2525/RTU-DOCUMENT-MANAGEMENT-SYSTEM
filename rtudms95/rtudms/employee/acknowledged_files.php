...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,TIMEDOWNLOAD,DOWNLOAD FROM upload_files WHERE (EMAIL ='$id' AND DOWNLOAD >'0' AND ARCHIVE ='0' AND SENDTO!='Private') group by NAME DESC";
