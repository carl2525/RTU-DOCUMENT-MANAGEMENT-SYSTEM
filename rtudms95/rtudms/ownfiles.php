...
<table id="dtable" class = "table table-striped w-100">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
        ...
        $query="SELECT DISTINCT ID,controlNumber,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE (EMAIL ='$id' AND SENDTO !='Private' AND ARCHIVE ='0') group by ID DESC";
