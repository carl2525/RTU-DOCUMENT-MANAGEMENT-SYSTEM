...
<div class="row d-md-block w-100 ms-0">
    <div class="col-md-2 d-flex flex-column min-vh-100 flex-shrink-2 p-3 pt-4 float-start" style=" background-color: #10164D;">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1">o
      <li class="nav-item">
      ...
      <a href="manage_folder.php" class="nav-link active">
    ...
    <li>
        <a href="#" class="nav-link text-white" data-bs-toggle="modal" data-bs-target="#modalRegisterForm">
          <i class="fas fa-users me-2"></i>Add Employee Account
        </a>
      </li>
      <li>
        <a href="#" class="nav-link text-white">
    ...
    <div class="dropdown">
      <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <strong>Logged in as:<br><?php echo ucwords(htmlentities($name)); ?></strong>
      </a>
      ...
      <div class="col-md-10 headertop ms-0 float-end " style= " background-color: #00396D; z-index: -1;">
    <header class="d-flex flex-wrap justify-content-center ms-0 w-100 py-4 mb-6 border-bottom border-5 border-warning" style="height: 80px; z-index: -1">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-light text-decoration-none ms-5">
        
      </a>
    </header>
</div>

 <div class="col-md-10 headertop ms-0 float-end ">
...
<!-- 
 ...
 <div class="col-md-10 headertop ms-0 float-start ">
<div class="container-fluid">
    <!--   <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalRegisterForm">Add File</button> -->
    <a href="addfile.php"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fa fa-file-image"></i>   View File Document</button></a>
    <hr>
    </div>
  </div>
      ...
      <div class="row"><br><br>
        <form action="fileprocess.php" method="post" enctype="multipart/form-data">
          ...
          <input type="file" name="myfile"><br>
           ...
           <label for="department">Choose a Department Office:</label>
          ...
          <button type="submit" class="btn fw-bold btn-rounded btn-block my-4 waves-effect z-depth-0" name="save" style ="background:#E0A100;" >UPLOAD</button>
...
<!-- Material form login -->
   <br><br>
      ...
      <div class="col-md-10 footerTop ms-0 position-absolute bottom-0 end-0" style= "background-color: #00396D; z-index: -1">
    <div class="footertop" style="background:#00396D; margin-top: -0px; z-index: -1; height: 53px;">
  ...
  <div class="modal-dialog modal-dialog-centered border-bottom border-top border-5 rounded-4" role="document">
    <div class="modal-content bg-light">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold" style="color: #10164D;"><i class="fas fa-user-plus"></i> ADD EMPLOYEE ACCOUNT</h4>
      ...
      <div class="modal-body">
        ...
        <div class="form mb-3">
        <label class="ms-1 mb-1"><i class="fas fa-users prefix grey-text"></i>  Admin or Employee</label>
       ...
       <div class="form-floating mb-3">
        ...
        <label for="email"><i class="fas fa-envelope prefix grey-text ms-1"></i>   Enter Name</label>
    </div>

    <div class="form-floating mb-3">
        <input type="text" class="form-control" id="email" placeholder="Enter email" name="admin_user">
        <label for="email"><i class="fas fa-envelope prefix grey-text ms-1"></i>   Enter Email</label>
    </div>

      <div class="form-floating mb-3">
        <input type="password" class="form-control" id="pass" placeholder="Enter password" name="admin_password" required>
        <label for="email"><i class="fas fa-lock prefix grey-text ms-1"></i>   Enter Password</label>
    </div>
