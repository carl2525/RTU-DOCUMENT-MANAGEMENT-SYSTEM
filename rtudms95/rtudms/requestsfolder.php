    ...
    <option name="offices" value="<?php echo $offices; ?>"><?php echo $offices; ?></option>  <?php  } ?>
                    ...
                    <div class="form-group ps-2">
                        <div class="input-group">
                            ...
                            <a href="add_requests.php"><button type="button" class=" ms-1 btn btn-success waves-effect rounded-4 waves-light"><i class="fa fa-file-medical"></i>   Create Requests</button></a>
