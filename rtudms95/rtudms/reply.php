...
<div class="row d-md-block w-100 ms-0">
    ...
    <ul class="nav nav-pills flex-column mb-auto px-1"id="itemSidebar">
      ...
      <ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;"><li>
        ...
        <li>
        <a href="sharedwithme.php" class="nav-link dropdown-item text-white active">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#folder"/></svg>
           - Shared With Me
        </a></li>
      </ul>
...
<div class="container-fluid">
 ...
 <a href="add_file.php"><button type="button" class="btn btn-success waves-effect waves-light rounded-4"><svg class="" width="20" height="20"><use xlink:href="#add"></use></svg>Upload File Document</button></a>
    <hr>
    </div>
  </div>
   ...
   <thead class="">
    ...
    <th class="desktop">Action</th>
     ...
     <?php
         ...
         $queryEmail = "SELECT SENDTO FROM upload_files";
          $resultEmail=mysqli_query($conn,$queryEmail);



        $query="SELECT DISTINCT controlNumber,ID,NAME,DEPARTMENT,SIZE,DESCRIPTION,SENDTO,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE (EMAIL!='$id' AND ARCHIVE = '0' AND SENDTO='All' OR SENDTO ='$id')  ORDER by ID DESC";
    ...
    <?php
      ...
      if ($sendto != 'All'){
        echo "<a href='reply.php?id={$id}'class='btn btn-sm btn-outline-success'><i class='fa fa-reply'></i></a>";
      }
    ?>
 ...
 <script>
              ...
              document.querySelector("body").style.overflow = 'visible';
                   ...
                   <a href="archive.php?ID=<?php echo  $id; ?>" class="btn btn-sm btn-outline-danger" onclick="yesNO(event)"><i class="fa fa-archive"></i>
           <script>
              function yesNO(ev){
                document.querySelector("body").style.overflow = 'hidden';
                ev.preventDefault();
...
?>
  <div class="modal-dialog rounded-5" role="document">
    <form method="post" enctype="multipart/form-data" action="replyProcess.php" >
    <div class="modal-content rounded-5">
      <div class="modal-header text-center rounded-5">
        <h4 class="modal-title w-100 font-weight-bold"><svg class="" width="32" height="32"><use xlink:href="#plane"/></svg> <?php echo $email;?></h4>
        ...
        <div class="modal-body">
          ...
          <img src="../assets/img/share1.gif" height="220px" width="300px" >
           ...
           <div class="md-form mb-2">
              <input type="file" class="form-control fw-bold rounded-4 mb-3 mt-1" id="firstname" name="myfile" id="inputGroupFile04" aria-describedby="inputGroupFileAddon04" aria-label="Upload" required>

            <input type="hidden" class="form-control" placeholder="Enter New Name" name="id" value="<?php echo $idname;?>">
            <input type="hidden" class="form-control" placeholder="Enter New Name" name="sendTo" value="<?php echo $email;?>">
             <input type="hidden" class="form-control" placeholder="Enter New Name" name="foldername" value="<?php echo $department;?>">
        </div>
        ...
        <div class="form-floating mb-3">
          ...
          <label for="email"><svg class="" width="20" height="20"><use xlink:href="#email"/></svg>    Subject File</label>
        </div>
                <div class="form-floating mb-3">
