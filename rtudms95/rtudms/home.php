    ...
    <li>
      ...
      <li>
        <a href="#" class="nav-link text-white dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
          <svg class="bi pe-none me-2" width="16" height="16"><use xlink:href="#addrescard"/></svg>
          View Account
        </a><ul class="dropdown-menu fw-normal border-top border-bottom border-3 border-warning ms-3" style="background-color: #10164D;">
          <li>
...
$result = mysqli_query($conn, "SELECT SUM(DOWNLOAD) AS sum FROM download_log"); 
  $row = mysqli_fetch_assoc($result); 
  $sum = $row['sum'];      

$resultUp = mysqli_query($conn, "SELECT SUM(UPLOAD) AS sumUp FROM upload_log"); 
...
<div class="container-fluid" style="visibility: hidden; display: none;" id="piechart_download">
        <div class="card mb-4 shadow bg-light rounded-4">
                      ...
                      <div class="card-body text-center p-4">
                        ...
                        <h1 class="display-1 fw-bold"><?php echo $sum?></h1>
        ...
        <div class="card mb-4 shadow bg-light rounded-4">
                      ...
                      <!--Card content-->
                       <div class="card-body text-center p-4">
                         ...
                         <h1 class="display-1 fw-bold"><?php echo $sumUp?></h1>
